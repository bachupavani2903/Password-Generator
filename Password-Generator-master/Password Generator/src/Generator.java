...
public class Generator {
    ...
    private void printUsefulInfo() {
        System.out.println();
        System.out.println("Information should be followed:");
        ...
        System.out.println(
                "5.Avoid character repetition, keyboard patterns, dictionary words, letter or number sequences," +
                        "usernames, relative or pet names,links (current or past) " +
    ...
    public Alphabet getAlphabet() {
        throw new UnsupportedOperationException("Unimplemented method 'getAlphabet'");
    }
}